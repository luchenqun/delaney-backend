...
CREATE TABLE
  IF NOT EXISTS user (
    ...
    mud NUMERIC NOT NULL DEFAULT 0,
    usdt NUMERIC NOT NULL DEFAULT 0,
    sub_person INT NOT NULL DEFAULT 0,
    sub_mud NUMERIC NOT NULL DEFAULT 0,
    sub_usdt NUMERIC NOT NULL DEFAULT 0,
    team_person INT NOT NULL DEFAULT 0,
    team_mud NUMERIC NOT NULL DEFAULT 0,
    team_usdt NUMERIC NOT NULL DEFAULT 0,
...
CREATE TABLE
  IF NOT EXISTS delegate (
    ...
    mud NUMERIC NOT NULL DEFAULT 0,
    min_usdt NUMERIC NOT NULL DEFAULT 0,
    usdt NUMERIC NOT NULL DEFAULT 0,
    back_min_mud NUMERIC NOT NULL DEFAULT 0,
    back_mud NUMERIC NOT NULL DEFAULT 0,
...
CREATE TABLE
  IF NOT EXISTS claim (
    ...
    address CHAR(42) NOT NULL,
    usdt NUMERIC NOT NULL DEFAULT 0,
    min_mud NUMERIC NOT NULL DEFAULT 0,
    mud NUMERIC NOT NULL DEFAULT 0,
